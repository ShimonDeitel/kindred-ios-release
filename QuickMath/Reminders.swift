...
enum Reminders {
    private static let identifier = "kindred.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Remember someone today"
        content.body = "Kindred has a detail to resurface from someone you care about."
